...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public OrderModel createOrder(Integer userId, Integer itemId, Integer amount, Integer promoId , String stockLogId) throws BuinessException {
...
//        UserModel userModel = userService.getUserById(userId);
        UserModel userModel = userService.getUserByIdCache(userId);
...
////                    throw new BuinessException(EmBusinessError.MQ_SEND_FAIL);
////                }
//            }
//        });
